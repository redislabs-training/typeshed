...
class Redis(object):
    ...
    def geodist(self, name, place1, place2, unit=...): ...
    def geohash(self, name, *values): ...
    def geopos(self, name, *values): ...
    def georadius(self, name, longitude, latitude, radius, unit=..., withdist=..., withcoord=..., withhash=..., count=..., sort=..., store=..., store_dist=...): ...
    def georadiusbymember(self, name, member, radius, unit=..., withdist=..., withcoord=..., withhash=..., count=..., sort=..., store=..., store_dist=...): ...
